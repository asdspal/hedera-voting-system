...
declare namespace Status {
    ...
    let InvalidMetadataKey: Status;
    let TokenHasNoMetadataKey: Status;
    let MissingTokenMetadata: Status;
    let MissingSerialNumbers: Status;
    let TokenHasNoAdminKey: Status;
    let NodeDeleted: Status;
    let InvalidNodeId: Status;
    let InvalidGossipEndpoint: Status;
    let InvalidNodeAccountId: Status;
    let InvalidNodeDescription: Status;
    let InvalidServiceEndpoint: Status;
    let InvalidGossipCaCertificate: Status;
    let InvalidGrpcCertificate: Status;
    let InvalidMaxAutoAssociations: Status;
    let MaxNodesCreated: Status;
    let IpFqdnCannotBeSetForSameEndpoint: Status;
    let GossipEndpointCannotHaveFqdn: Status;
    let FqdnSizeTooLarge: Status;
    let InvalidEndpoint: Status;
    let GossipEndpointsExceededLimit: Status;
    let TokenReferenceRepeated: Status;
    let InvalidOwnerId: Status;
    let TokenReferenceListSizeLimitExceeded: Status;
    let ServiceEndpointsExceededLimit: Status;
    let InvalidIpv4Address: Status;
    let EmptyTokenReferenceList: Status;
    let UpdateNodeAccountNotAllowed: Status;
}
